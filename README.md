...
I like approaching development methodically: understanding the problem, evaluating the context, and taking the time to find a solution that is not only functional, but also **clean, efficient, and appropriate for its purpose**.
...
Projects are one of the main ways I learn, experiment, and deepen my understanding of Computer Science.

Some repositories remain private while they are under active development or contain university project material. Completed projects and selected work are made publicly available whenever possible.
...
The project helped me work on both application logic and user experience, with particular attention to usability, responsiveness, and the interaction between frontend and backend components.
...
Some are created to solve practical problems, while others simply help me understand how something works by implementing it myself.
